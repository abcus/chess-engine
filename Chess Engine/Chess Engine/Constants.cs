...
namespace Chess_Engine {
    ...
    internal static class Constants {
        ...
        internal const int BROKER_CAPACITY = 4;
        ...
        public static readonly int[] singlePushCaptureLower = {Constants.H2, Constants.H3};
        public static readonly int[] singlePushCaptureUpper = {Constants.A6, Constants.A7};
        public static readonly int[] doublePushLower = {Constants.H2, Constants.H7};
        public static readonly int[] doublePushUpper = {Constants.A2, Constants.A7};
        public static readonly ulong [] enPassantRank = {Constants.RANK_6, Constants.RANK_3};
        public static readonly int[] enPassantLower = {Constants.H5, Constants.H4};
        public static readonly int[] enPassantUpper = {Constants.A5, Constants.A4};
        public static readonly int[] promotionPromotionCaptureLower = {Constants.H7, Constants.H2};
        public static readonly int[] promotionPromotionCaptureUpper = {Constants.A7, Constants.A2};
        ...
        //Single pawn moves and move-promitions for white and black from any position (for rank 1 and rank 8, no valid single pawn moves)
        //Starts at H1 and goes to A8
        public static readonly ulong[,] singlePawnMovesAndPromotions = {
        ...
        //Pawn captures and capture-promotions for white and black from any position (for rank 1 and 8, no valid moves)
        //Starts at H1 and goes to A8
        public static readonly ulong[,] capturesAndCapturePromotions = {
